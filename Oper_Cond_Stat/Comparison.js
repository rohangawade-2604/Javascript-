...
// !== it checks if the values are not equal and also checks the data type
console.log("a !== d is", a !== d);  // Output: a !== d is true, it checks if a is not equal to d and also checks the data type 
